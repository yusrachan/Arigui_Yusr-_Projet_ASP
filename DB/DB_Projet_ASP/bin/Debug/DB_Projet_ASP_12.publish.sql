...
GO
PRINT N'Modification de Procédure [dbo].[SP_Medias_Insert]...';


GO
ALTER PROCEDURE [dbo].[SP_Medias_Insert]
	@id_prod INT,
	@li NVARCHAR(255)
AS
	INSERT INTO [Medias] ([lien], [Id_Prod])
		...
		VALUES (@li, @id_prod)
GO
PRINT N'Modification de Procédure [dbo].[SP_Medias_Update]...';


GO
ALTER PROCEDURE [dbo].[SP_Medias_Update]
	@id_med INT,
	@li NVARCHAR(255),
	@id_prod INT
AS
